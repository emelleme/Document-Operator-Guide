...
<head>
    ...
    <script>!window.jQueryUI && document.write('<script src="js/jquery-ui-1.8.22.min.js"></script>
    ...
    <!-- Widgets -->
    <script src="js/powerwidgets.1.1.min.js"></script>
    <!-- Widgets panel -->
    <script src="js/powerwidgetspanel.1.1.min.js"></script>
    <!-- Select styling -->
    <script src="js/e_select.1.0.min.js"></script>    
    <!-- Checkbox solution -->
    <script src="js/e_checkbox.1.0.min.js"></script>
    <!-- Radio button replacement -->
    <script src="js/e_radio.1.0.min.js"></script>    
    <!-- Tabs -->
    <script src="js/e_tabs.1.0.min.js"></script>
    <!-- File styling -->
    <script src="js/e_file.1.0.min.js"></script>    
    <!-- MainMenu -->
    <script src="js/e_mainmenu.1.0.min.js"></script>
    <!-- Menu -->
    <script src="js/e_menu.1.0.min.js"></script>
    <!-- Input popup box -->
    ...
    <script src="js/e_contactform.1.0.min.js"></script>
                    ...
                    <div class="right">
                        ...
                        <nav id="main-breadcrumbs">
                            <ul>
                                ...
                                <li class="bc-tab-last">File Explore</li>
                            </ul>          
                        </nav>
                    ...
                    <aside>
                        ...
                        <nav id="main-menu">
                            <ul>
                                ...
                                <li class="page-active"><a href="fileexplore.html"><span class="folder-16 plix-16"></span> File Explore</a></li> 
					...
					<div id="content-main">
                        <div id="content-main-inner">
                            ...
                            <div class="page-header">
                                ...
                                <a href="doc-fileexplore.html" class="page-helper">Documentation</a>
                                 <a href="javascript:void(0);" class="page-helper empty-local-storage">Clear storage</a>
                                <p>Powerfull jQuery file explore.</p>
                            </div> 
