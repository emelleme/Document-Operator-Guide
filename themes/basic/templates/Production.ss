...
<html>
	<head>
		...
		<style type="text/css">
			...
			#left .middle_frame nav ul li a {color:#167cb6;display:block;font-weight:bold;line-height:30px;text-decoration:none;padding:0px 10px;height:30px;background:url('themes/basic/images/nav_item_new.png') center bottom repeat-x;}
