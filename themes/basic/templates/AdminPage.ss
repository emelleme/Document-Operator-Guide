        ...
        <header id="header">
            <div id="header-border">
                <div id="header-inner">
                    ...
                    <div class="left">
                        <a href="home" id="logo"><img src="themes/basic/images/opguide-logo.png" /></a>
                    </div><!-- End .left -->
                        ...
                        <nav>
                            ...
                            <a href="javascript:void(0);" class="button-icon plix-10" title="" id=""><span class="settings-10 plix-10"></span></a>
                                    ...
                                    <div>
                                        ...
                                        <ul>
                                            <li><a href="#"><span class="mail-10 plix-10"></span> Messages</a></li>
                                           <% if CurrentMember.inGroup(2) %>
                                            <li><a href="admin"><span class="upload-10 plix-10"></span> Admin Panel</a></li>
                                           <% end_if %>
                                            <li><a href="Security/logout"><span class="info-10 plix-10"></span> Logout</a></li>
                                        </ul>                                      
                                    </div> 
